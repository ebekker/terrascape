...
namespace HC.TFPlugin.Diagnostics
{
    public static class DiagnosticsExtensions
    {
        ...
        public static IHasDiagnostics  Error(this IHasDiagnostics hasDiags, string summary, string detail = null, TFSteps steps = null) =>
            Add(hasDiags, Diagnostic.Types.Severity.Error, summary, detail, steps);

        public static IHasDiagnostics  Warning(this IHasDiagnostics hasDiags, string summary, string detail = null, TFSteps steps = null) =>
