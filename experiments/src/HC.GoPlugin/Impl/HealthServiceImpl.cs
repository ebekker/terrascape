// Borrowed from:
//  https://github.com/grpc/grpc/tree/master/src/csharp/Grpc.HealthCheck
...
namespace HC.GoPlugin.Impl
{
    ...
    /// </code>
    /// </summary>
    internal class HealthServiceImpl : Grpc.Health.V1.Health.HealthBase, IHealthService
    {
        ...
        {
            // C#8.0:
            // var servingStatus = switch (status)
            // {
            ...
            switch (status)
            {
                case HealthStatus.Serving:
                    servingStatus = HealthCheckResponse.Types.ServingStatus.Serving;
                    break;
                case HealthStatus.NotServing:
                    servingStatus = HealthCheckResponse.Types.ServingStatus.NotServing;
                    break;
            }
